...
public class MouseCameraController extends GestureDetector {
	...
	protected static class CameraGestureListener extends GestureAdapter {
		public MouseCameraController controller;
	...
	protected MouseCameraController (final CameraGestureListener gestureListener, final Camera camera) {
	...
	public MouseCameraController (final Camera camera) {
